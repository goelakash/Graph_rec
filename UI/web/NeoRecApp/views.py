...
from forms import *
import sys
sys.path.append('/home/goelakash/dev/major/UI/web/NeoRecApp/cypher/cypher_interface')
import py2neo_cypher_interface as pci

def index(request):
    usage = []
    usage.append(["Enter User to get recommendations: ","/neorec/get_reco/",UserIDForm])
    usage.append(["Enter User to get rated movies: ","/neorec/view_ratings/",UserIDForm])
    usage.append(["Update rating for Movie for User: ","/neorec/update_ratings/",UpdateForm])
    usage.append(["Show all movies in database: ","/neorec/list_movies",""])
    ...
    response_dict["table_caption"] = "List of actions"
